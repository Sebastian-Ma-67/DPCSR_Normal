...
========================================*/
int Voxelization::PointBelongVoxel(const pcl::PointXYZ &oPoint)
{
...
========================================*/
int Voxelization::PointBelongVoxel(const pcl::PointXYZ &oPoint, IndexinAxis &oP3DIndex)
{
...
// compute a given point clouds belong to the corresponding voxel
void Voxelization::VoxelizePoints(const pcl::PointCloud<pcl::PointXYZ> &vSampledCloud, 
								  const pcl::PointCloud<pcl::PointXYZ> &vDenseCloud)
{
