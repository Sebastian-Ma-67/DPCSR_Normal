...
public:
	...
	//=====data=====
	// the index of the model surface vertices without face relative to viewpoint
	std::vector<pcl::Vertices> m_vSurfaceIdxs;

	// the index of the input points corresponding to the vertices of the convex hull(with viewpoint)
